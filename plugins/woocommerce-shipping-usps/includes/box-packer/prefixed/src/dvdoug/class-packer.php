...
class Packer extends Abstract_Packer
{
    ...
    {
        $this->items[] = new Item($this->dimension_unit, $this->weight_unit, $length, $width, $height, $weight, $value, $meta);
    }
    /**
     * @param $length
     * @param $width
     ...
     * @param string $type
     *
     * @return \WC_USPS\WooCommerce\BoxPacker\DVDoug\Box
     */
