...
namespace WC_USPS\Psr\Log\Test;

use WC_USPS\Psr\Log\LoggerInterface;
use WC_USPS\Psr\Log\LogLevel;
use WC_USPS\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('WC_USPS\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WC_USPS\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WC_USPS\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
