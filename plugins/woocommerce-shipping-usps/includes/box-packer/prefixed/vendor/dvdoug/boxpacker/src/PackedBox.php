...
class PackedBox implements JsonSerializable
{
    ...
    {
        return ['box' => ['reference' => $this->box->getReference(), 'innerWidth' => $this->box->getInnerWidth(), 'innerLength' => $this->box->getInnerLength(), 'innerDepth' => $this->box->getInnerDepth()], 'items' => iterator_to_array($this->items)];
    }
}
