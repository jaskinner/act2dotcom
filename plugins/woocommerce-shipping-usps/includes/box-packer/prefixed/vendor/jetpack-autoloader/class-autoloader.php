...
class Autoloader
{
    ...
    public static function init($container = null)
    {
        ...
        if (!isset($container)) {
            ...
            $container = new \Automattic\Jetpack\Autoloader\jp7c1c870a3b181d6d210094d5b549780f\Container();
        }
        // phpcs:disable Generic.Commenting.DocComment.MissingShort
        /** @var Autoloader_Handler $autoloader_handler */
        $autoloader_handler = $container->get(\Automattic\Jetpack\Autoloader\jp7c1c870a3b181d6d210094d5b549780f\Autoloader_Handler::class);
        ...
        $plugin_locator = $container->get(\Automattic\Jetpack\Autoloader\jp7c1c870a3b181d6d210094d5b549780f\Plugin_Locator::class);
        /** @var Plugins_Handler $plugins_handler */
        $plugins_handler = $container->get(\Automattic\Jetpack\Autoloader\jp7c1c870a3b181d6d210094d5b549780f\Plugins_Handler::class);
        ...
        $guard = $container->get(\Automattic\Jetpack\Autoloader\jp7c1c870a3b181d6d210094d5b549780f\Latest_Autoloader_Guard::class);
        ...
        $hook_manager = $container->get(\Automattic\Jetpack\Autoloader\jp7c1c870a3b181d6d210094d5b549780f\Hook_Manager::class);
        // Register a shutdown handler to clean up the autoloader.
        $hook_manager->add_action('shutdown', new \Automattic\Jetpack\Autoloader\jp7c1c870a3b181d6d210094d5b549780f\Shutdown_Handler($plugins_handler, $cached_plugins, $was_included_by_autoloader));
