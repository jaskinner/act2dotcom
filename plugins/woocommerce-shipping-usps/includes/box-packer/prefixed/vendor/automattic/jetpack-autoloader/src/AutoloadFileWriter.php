...
AUTOLOADER_COMMENT;
    ...
    {
        $renameList = array('autoload.php' => '../autoload_packages.php');
        $ignoreList = array('AutoloadGenerator.php', 'AutoloadProcessor.php', 'CustomAutoloaderPlugin.php', 'ManifestGenerator.php', 'AutoloadFileWriter.php');
        ...
        foreach ($files as $file) {
            ...
            if (\in_array($file, $ignoreList, \true)) {
                continue;
            }
    ...
    private static function prepareAutoloaderFile($filename, $suffix)
    {
        ...
        return \str_replace('/* HEADER */', $header, $file_contents);
    }
}
